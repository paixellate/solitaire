...
export function getDefaultLayout(windowWidth: number, windowHeight: number): LayoutConfig {
  return {
    ...
    get topPileVerticalOffset() { return this.boardHeight/2  - this.pileSpacingVertical * 0.6 },
    get bottomPileVerticalOffset() { return (this.topPileVerticalOffset) - this.pileSpacingVertical; },
    
    // Pile positions
    get foundationPilesPosition() { return vec3(-1.5 * this.pileSpacing, this.topPileVerticalOffset, 0); },
    get wastePilePosition() { return vec3(2 * this.pileSpacing, this.topPileVerticalOffset, 0); },
    get stockPilePosition() { return vec3(3 * this.pileSpacing, this.topPileVerticalOffset, 0); },
    get tableauPilesPosition() { return vec3(0, this.bottomPileVerticalOffset, 0); },
    selectionPilePosition: vec3(0, 0, 0),

    // Controls
    get controlsVerticalOffset() { return -this.boardHeight/2 + 80 },
    get buttonWidth() { return 50 },
    get buttonHeight() { return 50 },
  };
}
